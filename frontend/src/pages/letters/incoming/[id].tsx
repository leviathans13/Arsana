...
export default function IncomingLetterDetailPage() {
  ...
  const handleDownload = () => {
    if (letter?.id) {
      ...
      link.href = `${process.env.NEXT_PUBLIC_API_URL || 'http://localhost:3001/api'}/files/incoming/${letter.id}`;
              ...
              <div className="bg-white shadow-sm rounded-xl p-6 border border-gray-200">
                ...
                <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                  ...
                  <button
                    ...
                    className="ml-4 flex-shrink-0 inline-flex items-center p-2 border border-transparent rounded-full shadow-sm text-white bg-blue-600 hover:bg-blue-700"
                  >
